<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_UserListingReport" CodeFile="PG_UserListingReport.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <script type="text/javascript" src="../include/js/Forms/userListing.js"></script>
            ...
            <asp:TableCell Width="100%">
                        ...
                        <asp:Table Width="90%" CellPadding="2" CellSpacing="0" ID="Table2" runat="Server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="20%" Wrap="False">
                                    <asp:Label ID="radFrom" runat="Server" CssClass="LABEL" Text="Creation From Date"></asp:Label>
                                </asp:TableCell>
				...
				<a href="#" onclick='popUpCalendar(this, document.forms[0].ctl00$cphContent$textFromDt, "dd/mm/yyyy");'>
                    <img src="../Include/Images/date.gif" border="0" /></a>
                                    <asp:Label runat="Server" CssClass="LABEL" Text="Creation To Date" ID="Label2"></asp:Label>&nbsp;
                    ...
                    <img src="../Include/Images/date.gif" border="0" /></a>
                            ...
                            <asp:TableRow>
                                ...
                                <asp:TableCell Width="30%">
                                    ...
                                    <asp:Label ID="Label3" runat="Server" CssClass="LABEL" Text="Staff Number"></asp:Label> &nbsp;
                                    <asp:TextBox ID="textStaffNumber" runat="Server" CssClass="MEDIUMTEXT" MaxLength="14"></asp:TextBox>
    ...
    <table id="example" class="display" style="width: 100%; border-color: Black; border-width: 1px; border-style: solid; font-size: 8pt; border-collapse: collapse;">
        <thead style="background: #CCCCCC;">
            ...
            <tr class="hidden-row">
                <th colspan="7">Report Date : <p id="dateTime"></p>

                </th>
            </tr>

            <tr class="hidden-row">
                <th colspan="7">Report Generated By : <%=Names%> </th>
            </tr>
            ...
            <tr>
                ...
                <th>User Role</th>
                <th>User Status</th>
                <th>Last Successful Login Date</th>
                <th>Creation Date</th>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("StaffNumber") %></td>
                        <td><%# Eval("User_Flag") %></td>
                        <td><%# Eval("User_Status") %></td>
                        <td><%# Eval("User_LoginDt") %></td>
                        <td><%# Eval("User_CreatedDt") %></td>
