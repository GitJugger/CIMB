<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_ViewRoles" CodeFile="PG_ViewRoles.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
		...
		<asp:TableCell Width="100%">
			...
			<asp:Table Width="100%" CellPadding="2" CellSpacing="0" Runat="Server">
				...
				<asp:TableRow>
					...
					<asp:TableCell Width="80%">
							<asp:TextBox ID="txtKeyword" CssClass="MEDIUMTEXT" Runat="Server" MaxLength="20"></asp:TextBox></asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
	...
	<asp:Table Width="100%" CellPadding="2" BorderWidth="0" CellSpacing="0" Runat="server" ID="tblRole">
		...
		<asp:TableRow BorderWidth="1">
			<asp:TableCell ><asp:Label Runat="Server" Text="Report Downloader" CssClass="LABEL" ID="Label1" NAME="Label1"></asp:Label></asp:TableCell>
			<asp:TableCell  HorizontalAlign="Center">&nbsp;
		...
		<asp:TableCell Width="100%">
		  <asp:Panel ID="pnlGrid" runat="server" CssClass="GridDivNoScroll">
            ...
            <asp:TemplateColumn HeaderText="Select" HeaderStyle-Width="5%">
                <ItemTemplate>
                    <a id="aModify" href="PG_CreateRole.aspx?Id=<%# GetEncrypterString(DataBinder.Eval(Container.DataItem, "UserId"))%>&LoginId=<%# GetEncrypterString(DataBinder.Eval(Container.DataItem, "UserLogin"))%>"><asp:Label ID="lblModify" runat="server">Modify</asp:Label></a>
                </ItemTemplate>
            </asp:TemplateColumn>				
            <asp:TemplateColumn HeaderText="Select" HeaderStyle-Width="7%">
                <ItemTemplate>
                    <a id="aChgPwd" href="PG_ChangePassword.aspx?Id=<%# GetEncrypterString(DataBinder.Eval(Container.DataItem, "UserId"))%>"><asp:Label ID="lblChgPwd" runat="server">Change Password</asp:Label></a>
                </ItemTemplate>
            </asp:TemplateColumn>	
            <asp:TemplateColumn HeaderText="Select" HeaderStyle-Width="12%">
                <ItemTemplate>
                    <a id="aChgPwd" href="PG_ChangeAuthCode.aspx?Id=<%# GetEncrypterString(DataBinder.Eval(Container.DataItem, "UserId"))%>"><asp:Label ID="lblChgAuth" runat="server">Change Validation Code</asp:Label></a>
                </ItemTemplate>
            </asp:TemplateColumn>	
