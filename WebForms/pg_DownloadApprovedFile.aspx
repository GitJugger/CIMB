<%@ Page Language="VB" AutoEventWireup="false" CodeFile="pg_DownloadApprovedFile.aspx.vb" Inherits="MaxPayroll.pg_DownloadApprovedFile" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
  ...
  //      }
    ...
    <table cellpadding="8" cellspacing="0" width="100%" border="0">
        <tr>
            <td>
                <asp:Panel ID="pnlGrid" runat="server" CssClass="GridDiv"  ScrollBars="Vertical">
				    <asp:DataGrid ID="dgNewFile" Runat="Server" AllowPaging="True" AllowSorting="False" AutoGenerateColumns="False" PagerStyle-Mode="NumericPages"  CellPadding="3" CellSpacing="0" PageSize="13" GridLines="none" PagerStyle-HorizontalAlign="Center" Font-Names="Verdana" Font-Size="8pt" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-CssClass="GridItemStyle" AlternatingItemStyle-CssClass="GridAltItemStyle" Width="98%" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
		                <Columns>
		                <asp:BoundColumn DataField="FileId" Visible="false"></asp:BoundColumn>
		                    ...
		                    <asp:BoundColumn DataField="FileType" HeaderText="File Type" Visible="true"></asp:BoundColumn>    
		                    <asp:BoundColumn DataField="FileAttribute" Visible="false"></asp:BoundColumn>                      
		                    <asp:TemplateColumn HeaderText="New Approved File">
		                        <ItemTemplate>
                ...
                <asp:Panel ID="pnlDownloadedFile" runat="server" CssClass="GridDiv" ScrollBars="Vertical">
				    <asp:DataGrid ID="dgDownloadedFile" Runat="Server" AllowPaging="True" AllowSorting="False" AutoGenerateColumns="False" PagerStyle-Mode="NumericPages"  CellPadding="3" CellSpacing="0" PageSize="13" GridLines="none" PagerStyle-HorizontalAlign="Center" Font-Names="Verdana" Font-Size="8pt" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-CssClass="GridItemStyle" AlternatingItemStyle-CssClass="GridAltItemStyle" Width="98%" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
		                ...
		                <asp:BoundColumn DataField="FileId" Visible="false"></asp:BoundColumn>
		                    ...
		                    <asp:BoundColumn DataField="FileType" HeaderText="File Type" Visible="True"></asp:BoundColumn>    
		                    <asp:BoundColumn DataField="FileAttribute" Visible="false"></asp:BoundColumn>              
		                    <asp:TemplateColumn HeaderText="Downloaded File">
		                        <ItemTemplate>
		                            <a id="lnkNewFile" runat="server"></a>
		                            <asp:LinkButton CommandName="Download" runat="server" ID="lnkBtnNewFile" ></asp:LinkButton>
		                        </ItemTemplate>
