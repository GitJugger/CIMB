            ...
            Try
                ...
                If Not Page.IsPostBack Then
                    ...
                    If hEpf.Value = "Y" Then
                        dsTemp.Reset()
                        dsTemp = clsCustomer.fncGrpCommon("EPF DEFAULT", ss_lngOrgID, ss_lngUserID, "")
                        Call fncPopulateCheckBox(dsTemp, chkEpfAccts, "SRNAME", "SRID")
                    Else
                        'trEPF.Visible = False
                    ...
                    If hSoc.Value = "Y" Then
                        dsTemp.Reset()
                        dsTemp = clsCustomer.fncGrpCommon("SOCSO DEFAULT", ss_lngOrgID, ss_lngUserID, "")
                        Call fncPopulateCheckBox(dsTemp, chkSocAccts, "SRNAME", "SRID")
                    Else
                        'trSoc.Visible = False
                    ...
                    If hLHDN.Value = "Y" Then
                        dsTemp.Reset()
                        dsTemp = clsCustomer.fncGrpCommon("LHDN DEFAULT", ss_lngOrgID, ss_lngUserID, "")
                        Call fncPopulateCheckBox(dsTemp, chkLHDNAccts, "SRNAME", "SRID")
                    Else
                    ...
                    Else
                        ...
                        If hEpf.Value = "Y" Then
                            dsTemp.Reset()
                            dsTemp = clsCustomer.fncListGroup("EPF TRANS", ss_lngOrgID, ss_lngUserID, rq_lngGroupID)
                            Call prcCheckedItems(dsTemp, chkEpfAccts, "ACCID")
                        End If
                        ...
                        If hSoc.Value = "Y" Then
                            dsTemp.Reset()
                            dsTemp = clsCustomer.fncListGroup("SOCSO TRANS", ss_lngOrgID, ss_lngUserID, rq_lngGroupID)
                            Call prcCheckedItems(dsTemp, chkSocAccts, "ACCID")
                        End If
                        ...
                        If hLHDN.Value = "Y" Then
                            dsTemp.Reset()
                            dsTemp = clsCustomer.fncListGroup("LHDN TRANS", ss_lngOrgID, ss_lngUserID, rq_lngGroupID)
                            Call prcCheckedItems(dsTemp, chkLHDNAccts, "ACCID")
                        End If
