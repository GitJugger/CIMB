...
Namespace MaxPayroll
    ...
    Partial Class PG_UserListingReport
...
#Region "Page Load"
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            lblHeading.Text = "User Listing Report"
...
#Region "Bind Grid"
        ...
        Private Sub prcBindGrid()
            ...
            Dim strFromDt As String, strToDt As String, strOption As String = "", strUserLogin As String, strUserName As String, strStaffName As String
            ...
            Try
                ...
                strStaffName = textStaffNumber.Text
                'lblMessage.Text = ""
                ...
                dsLogs = clsBank.GetUserListing(strFromDt, strToDt, strUserLogin, strUserName, strStaffName)
