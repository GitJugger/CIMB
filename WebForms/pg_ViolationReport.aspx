<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_ViolationReport" CodeFile="PG_ViolationReport.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <script type="text/javascript" src="../include/js/Forms/violation.js"></script>
            ...
            <asp:TableCell Width="100%">
                        ...
                        <asp:Table Width="90%" CellPadding="2" CellSpacing="0" ID="Table2" runat="Server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell Width="20%" Wrap="False">
                                    <asp:Label ID="radFrom" runat="Server" CssClass="LABEL" Text="Login From Date"></asp:Label>
                                </asp:TableCell>
				...
				<a href="#" onclick='popUpCalendar(this, document.forms[0].ctl00$cphContent$textFromDt, "dd/mm/yyyy");'>
                    <img src="../Include/Images/date.gif" border="0" /></a>
                                    <asp:Label runat="Server" CssClass="LABEL" Text="Login To Date" ID="Label2"></asp:Label>&nbsp;
    ...
    <table id="example" class="display" style="width: 100%; border-color: Black; border-width: 1px; border-style: solid; font-size: 8pt; border-collapse: collapse;">
        <thead style="background: #CCCCCC;">
            ...
            <tr class="hidden-row">
                <th colspan="4">Report Date : <p id="dateTime"></p>

                </th>
            </tr>

            <tr class="hidden-row">
                <th colspan="4">Report Generated By : <%=Names%> </th>
            </tr>
        ...
        <tbody>
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        <td><%# Eval("User_Id") %></td>
                        <td><%# Eval("Failed_AttemptDt") %></td>
                        <td><%# Eval("Error_Msg") %></td>
