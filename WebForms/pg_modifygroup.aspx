<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_ModifyGroup" CodeFile="PG_ModifyGroup.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
		...
		function fncBack()
		{
			var strRequest;	
			var iPageNo;
			strRequest = document.timerform.hRequest.value;
			iPageNo = document.timerform.hPageNo.value
			if(strRequest == "")
			{
    ...
    <!-- Main Table Ends Here -->
      <asp:Table ID="tblMainForm" CellPadding="4" CellSpacing="1" Runat="Server" BorderWidth="0" Width="100%">
										<asp:TableRow>
			...
			<asp:Label Runat="Server" CssClass="MAND" Text="*" ID="Label29" NAME="Label10"></asp:Label>
										    ...
										    <asp:TableCell ColumnSpan="2">
										        <asp:DataGrid Runat="Server" ID="dgAccount" AllowSorting="false" AllowPaging="false" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center" GridLines="none" CellPadding="1" CellSpacing="0" Font-Names="Verdana" Font-Size="8pt" width="100%" HeaderStyle-Font-Bold="True"  AutoGenerateColumns="false" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" ShowHeader="false" AlternatingItemStyle-CssClass="GridAltItemStyle" BorderWidth="1">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="PaySer_Desc" HeaderText="" ItemStyle-Width="245"></asp:BoundColumn>
										...
										<asp:TableRow>
										    <asp:TableCell ColumnSpan="2">
										         <asp:DataGrid Runat="Server" ID="dgFormat" AllowSorting="false" AllowPaging="false" PagerStyle-Mode="NumericPages" AlternatingItemStyle-CssClass="GridAltItemStyle" PagerStyle-HorizontalAlign="Center" GridLines="none" CellPadding="1" CellSpacing="0" Font-Names="Verdana" Font-Size="8pt" width="100%" HeaderStyle-Font-Bold="True"  AutoGenerateColumns="false" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" ShowHeader="false" BorderWidth="1">
                                                    <Columns>
                                                        <asp:BoundColumn DataField="File_Type" HeaderText="File Type" ItemStyle-Width="245"></asp:BoundColumn>
...
<asp:Label Text="*" Runat="server" CssClass="MAND" ID="Label26"></asp:Label>
			...
			<input type="button" runat="Server" value="Back To View" onclick="fncBack();" class="BUTTON"/>
										...
										<asp:TableRow ID="trBack" Visible="False">
											<asp:TableCell Width="90%" ColumnSpan="4">
												<input type="button" runat="Server" onclick="fncBack();" value="Back"/>
											</asp:TableCell>
										</asp:TableRow>
									</asp:Table>
...
<input type="hidden" id="hLHDN" name="hLHDN" runat="Server"/>
			...
			<asp:Label CssClass="LABEL" Runat="Server" Text="Group Name" ID="Label12"></asp:Label>&nbsp;
											...
											<asp:TableCell Width="60%" ColumnSpan="3">
												<asp:TextBox ID="txtCGroupName" Runat="Server" CssClass="LARGETEXT" ReadOnly="True"></asp:TextBox>
                                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator4" Runat="server" ControlToValidate="txtCGroupName" ValidationExpression="^[\w\-\s]+$" ErrorMessage="Group Name Accepts Alpha Numeric, Underscore, Dash Only" Display="None"></asp:RegularExpressionValidator>
											</asp:TableCell>
										</asp:TableRow>
										<asp:TableRow>
											<asp:TableCell Width="30%" Wrap="False" VerticalAlign="Top">
			<asp:Label Runat="Server" CssClass="LABEL" Text="Group Description" ID="Label13"></asp:Label>&nbsp;
											...
											<asp:TableCell Width="60%" ColumnSpan="3">
												<asp:TextBox ID="txtCGroupDesc" Runat="Server" CssClass="LARGETEXT" TextMode="MultiLine" Rows="3"
                                                 ...
                                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator3" Runat="server" ControlToValidate="txtCGroupDesc" ValidationExpression="^[\w\-\s]+$" ErrorMessage="Group Desc Accepts Alpha Numeric, Underscore, Dash Only" Display="None"></asp:RegularExpressionValidator>
			...
			<asp:Label Runat="Server" CssClass="LABEL" Text="No of Approver(s) for Approval" ID="Label18"
											...
											<asp:TableCell Width="60%" ColumnSpan="3">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" Runat="server" ControlToValidate="txtCAuthCode" ValidationExpression="[A-Za-z0-9_-]{6,24}"
										ErrorMessage="Validation Code must be 6 to 24 Alpha Numeric Characters" Display="None"></asp:RegularExpressionValidator>
											</asp:TableCell>
										</asp:TableRow>
										<asp:TableRow>
											<asp:TableCell Width="30%">
										...
										<asp:TableRow ID="trCReason">
											...
											<asp:TableCell>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" Runat="server" ControlToValidate="txtCReason" ValidationExpression="^[\w\-\s]+$" ErrorMessage="Reason Accepts Alpha Numeric, Underscore, Dash Only" Display="None"></asp:RegularExpressionValidator>
											</asp:TableCell>
										</asp:TableRow>
			...
			<input type="button" value="Back" onclick="fncBack();" class="BUTTON"/>&nbsp;
		</asp:TableCell>
										</asp:TableRow>
									...
									<asp:RequiredFieldValidator ID="rfvReason" Runat="server" ControlToValidate="txtReason" ErrorMessage="Modification Reason cannot be blank"
										Display="None"></asp:RequiredFieldValidator>
									<asp:RegularExpressionValidator ID="rgeAuthCode" Runat="server" ControlToValidate="txtAuthCode" ValidationExpression="[A-Za-z0-9]{6,24}"
										ErrorMessage="Validation Code must be 6 to 24 Alpha Numeric Characters" Display="None"></asp:RegularExpressionValidator>
