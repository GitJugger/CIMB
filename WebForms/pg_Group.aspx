<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_Group" CodeFile="pg_Group.aspx.vb" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
		...
		function fncBack()
		{
			...
			var iPageNo;
			var isNew;
			strRequest = document.forms[0].ctl00$cphContent$hRequest.value;
			isNew = document.forms[0].ctl00$cphContent$hIsNew.value;
			iPageNo = document.forms[0].ctl00$cphContent$hPageNo.value;
			if(isNew == "New")
			{
				window.location.href = "pg_Group.aspx?Mod=New";
			}
			else
			{
			    if(strRequest == "")
