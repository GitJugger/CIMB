<%@ Page Language="vb" AutoEventWireup="false" Inherits="MaxPayroll.PG_Group3" CodeFile="pg_Group3.aspx.vb" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
		...
		function fncBack()
		{
			...
			isNew = document.timerform.hIsNew.value;
    ...
    <!-- Main Table Ends Here -->
      <asp:Table ID="tblMainForm" CellPadding="2" CellSpacing="1" Runat="Server" BorderWidth="0" Width="100%">
			...
			<asp:Label Runat="Server" CssClass="MAND" Text="*" ID="Label29" NAME="Label10"></asp:Label>
										...
										<asp:TableRow>
										    <asp:TableCell ColumnSpan="2">
										        <asp:DataGrid Runat="Server" ID="dgAccount" AllowSorting="false" AllowPaging="false" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center" GridLines="none" CellPadding="1" CellSpacing="0" Font-Names="Verdana" Font-Size="8pt" width="100%" HeaderStyle-Font-Bold="True"  AutoGenerateColumns="false" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" ShowHeader="True" AlternatingItemStyle-CssClass="GridAltItemStyle" BorderWidth="1">
										         ...
										         <asp:DataGrid Runat="Server" ID="dgFormat" AllowSorting="false" AllowPaging="false" PagerStyle-Mode="NumericPages" AlternatingItemStyle-CssClass="" PagerStyle-HorizontalAlign="Center" GridLines="none" CellPadding="3" CellSpacing="0" Font-Names="Verdana" Font-Size="8pt" width="100%" HeaderStyle-Font-Bold="True"  AutoGenerateColumns="false" CssClass="Grid" HeaderStyle-CssClass="GridHeaderStyle" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left" ShowHeader="false" BorderWidth="0">
                                                    <Columns>
                                                        <asp:BoundColumn DataField="File_Type" HeaderText="File Type" ItemStyle-Width="245" ItemStyle-VerticalAlign="Top" ></asp:BoundColumn>
										...
										<asp:Table ID="Table1" CellPadding="2" CellSpacing="1" Runat="Server" BorderWidth="0" Width="100%">
										<asp:TableRow>
											<asp:TableCell Width="30%" Wrap="False">
...
<asp:Label Text="*" Runat="server" CssClass="MAND" ID="Label26"></asp:Label>
                                            ...
                                            ErrorMessage="Reason Accepts Alpha Numeric, Underscore, Dash Only" ValidationExpression="^([a-zA-Z0-9_-])$"></asp:RegularExpressionValidator>
                                            </asp:TableCell>
										</asp:TableRow>
			...
			<input type="button" value="Back" onclick="fncBack();" class="BUTTON" runat="server" id="ipBack"/>&nbsp;
		</asp:TableCell>
										</asp:TableRow>
